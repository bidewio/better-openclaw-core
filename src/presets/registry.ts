...
const presets: Preset[] = [
	...
	},
	{
		...
		services: ["ffmpeg", "remotion", "minio", "redis"],
	...
	},
	{
		...
		services: ["postiz", "ffmpeg", "minio", "redis", "postgresql", "umami"],
	...
	},
	{
		...
		services: ["ollama", "open-webui", "litellm", "anything-llm", "redis"],
	...
	},
	{
		...
		services: ["claude-code", "opencode", "gitea", "code-server", "redis"],
